...
export default function FeaturesPage() {
  const features = [
    ...
    },
    {
      ...
      image: '/images/feature-integrity.png',
      title: 'Document Sealing (Veriflo Seal)',
      shortDesc: 'Fingerprint your documents, share them securely, and let recipients verify independently.',
      fullDesc: 'Veriflo Seal creates a cryptographic fingerprint of your document, stores it securely, and generates a unique verification link. Recipients can download the original document and independently verify their copy hasn\'t been tampered with — hashing runs client-side, so the file never leaves their browser. Set expiry dates, view limits, and send notification emails directly.',
      benefits: [
        'Cryptographic SHA-256 document fingerprinting',
        'Secure document storage and sharing',
        'Recipient-side tamper verification',
        'Set expiry dates and view limits',
        'Access logging with IP and device tracking',
        'Recipients verify without signing up',
      ],
    },
    {
      id: 'pii-redaction',
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            { title: 'Document Sealing', items: ['Cryptographic fingerprinting', 'Secure document sharing', 'Recipient-side verification'] },
            { title: 'PII Redaction', items: ['9-category PII detection', 'Permanent black-box redaction', 'Redaction audit trail'] },
